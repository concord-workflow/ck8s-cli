...
public class GenerateTokenCommand implements Callable<Integer> {
    ...
    private static String replaceConcordToken(String baseUrl, String accessToken) throws Exception {
    ...
    private static String createConcordToken(String baseUrl, String accessToken) throws Exception {
    ...
    private static List<Map<String, Object>> listConcordTokens(String baseUrl, String accessToken) throws URISyntaxException {
        String url = baseUrl + "/api/v1/apikey/";
    ...
    private static void deleteConcordToken(String baseUrl, String accessToken, String tokenId) throws Exception {
    ...
    private static String getOidcAccessToken(String oauthUrl, String clientId) throws Exception {
        ...
        if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
            ...
            LogUtils.warn("Could not open default browser. Open link manually: {}", verificationUrl);
        }
    ...
    private static Map<String, Object> requestDeviceVerificationCode(String oauthUrl, String clientId) throws Exception {
    ...
    private static Map<String, Object> requestToken(String oauthUrl, String clientId, String deviceCode) throws Exception {
        Map<String, String> form = new HashMap<>();
        form.put("client_id", clientId);
    ...
    private static HttpResponse<InputStream> post(String url, Map<String, String> form) throws Exception {
        HttpRequest.Builder requestBuilder = HttpRequest.newBuilder();
        HttpRequest request = requestBuilder
                .uri(new URI(url))
                .version(HttpClient.Version.HTTP_2)
    ...
    private static Map<String, Object> asMap(HttpResponse<InputStream> response) throws IOException {
