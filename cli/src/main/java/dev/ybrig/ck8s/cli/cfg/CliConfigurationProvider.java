...
public class CliConfigurationProvider {
    ...
    private static class MainProvider
        ...
        public CliConfiguration get() {
            var path = Paths.get(System.getProperty("user.home")).resolve(".ck8s").resolve("ck8s-cli.yaml");
    ...
    private static class DefaultsProvider
        ...
        @Override
        public CliConfiguration get() {
            try (var in = CliConfigurationProvider.class.getResourceAsStream("/templates/default-ck8s-cli-config.yaml")) {
